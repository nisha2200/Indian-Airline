...
<BODY>
	...
	<div id="register_form" align="center" height="200" width="200">
		<FORM name="register" method="post" action="register.php" onsubmit="return validate()">
			<TABLE border="0">
				<CAPTION>
					<FONT size="6"><br />Enter your details:</FONT>
				</CAPTION>
				<tr></tr>
				<tr></tr>
				<tr></tr>
				...
				<TR class="left">
					...
					<TD><INPUT name="fname" type="TEXT" placeholder="Enter your first name" size="30" maxlength="30"
							align="center" id="fname"></TD>
				</TR>
				<tr></tr>
				<tr></tr>
				<TR class="left">
				...
				<TR class="left">
					<TD>
						<FONT size="5">Confirm Password:</FONT>
					</TD>
			...
			<P><INPUT TYPE="Submit" value="Submit" name="submit" id="submit"
					class="button">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
