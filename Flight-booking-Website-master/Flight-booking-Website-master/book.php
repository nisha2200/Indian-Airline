...
<div style="width:100%; height:600px; color:gray;border:2px solid #1E3E63; border-radius:20px;">
	<h1 style="text-align:center; color:Black; font-style:italic; padding-top:50px;">You should login before Booking!</h1>
    <form name="loginform" action="loginprocess.php" method="POST">  
        <form action="customer/index.php" method="post">
            ...
            <div class="sub">
				<input type="submit" value="Login" class="des"/>  <br>
				<a style="text-align:center;text-decoration:none; font-size:20px;" href="signup.php">Don't have an account?</a>
			</div>
